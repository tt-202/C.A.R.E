...
Without GPIO, all reads return False (Firestore / app still control the arm).
"""
...
class ButtonManager:
    ...
    def poll(self) -> None:
        """Sample pins and latch edge-detected presses."""
        if not self.enabled:
            return
    ...
    def estop_held(self) -> bool:
        return self._pressed(self.estop_pin)
