...
GUI_MESSAGES = {
    ...
    "track_limit_move_left": "Please move slightly LEFT so I can line up safely.",
    "track_limit_move_right": "Please move slightly RIGHT so I can line up safely.",
    "track_limit_adjust_up_forward": "Please adjust your head slightly up or forward.",
    "track_limit_adjust_down_back": "Please adjust your head slightly down or back.",
    "track_limit_adjust_position": "Please adjust your head position so I can line up safely.",
